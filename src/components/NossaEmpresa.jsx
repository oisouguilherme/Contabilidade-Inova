...
export function NossaEmpresa(){
  return(
    <section id="SobreNos" className="max-w-6xl mx-auto grid gap-8 items-center md:grid-cols-2 py-12 px-4">
      <div className="space-y-4">
        <h2 className="text-4xl sm:text-5xl">Conheça <span className="font-medium text-azul">Nossa Empresa</span></h2>
