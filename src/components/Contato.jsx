...
export function Contato(){
  return(
    <div className="max-w-6xl mx-auto grid gap-12 grid-cols-2 items-center py-12">
      <div className="flex flex-col items-start gap-6">
        <h2 className="text-5xl font-medium"><span className="font-bold text-azul">Entre em contato</span> <br /> com a gente!</h2>
        <div>
