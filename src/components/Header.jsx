      ...
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:block">
          <ul className="flex space-x-12 font-medium text-white text-center items-center text-lg">
            ...
            <li className="cursor-pointer duration-300">Dúvidas</li>
            <li>
              <a
                href="#"
                className="bg-white hover:bg-opacity-95 duration-300 text-azul px-6 py-2 rounded-xl flex gap-3 items-center"
              >
                <svg
