...
export function InformacaoExtra(){
  return(
    <div className="grid md:grid-cols-2 max-w-6xl mx-auto py-12 items-center gap-12">
      <Image src={Empresa} alt="empresa" className="rounded-xl"/>
      <div className="flex flex-col items-start gap-6">
        <h2 className="text-5xl font-medium">Lorem ipsum <span className="font-bold text-azul">dolor sit amet </span>consectetur adipisicin.</h2>
