  ...
  return(
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center pt-12 px-4">
      <div className="flex flex-col items-start gap-4">
        ...
        <Link href="/servicos" className="sm:text-lg bg-azul hover:bg-opacity-95 duration-300 text-white px-12 py-3 font-medium rounded-xl">Conheça nossos serviços</Link>
      </div>
